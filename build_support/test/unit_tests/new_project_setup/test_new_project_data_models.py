...
def test_load(
    project_yaml_str: str, project_settings_data_dict: dict[str, Any]
) -> None:
...
def test_load_bad_name(project_settings_data_dict: dict[str, Any]) -> None:
...
def test_load_bad_license(project_settings_data_dict: dict[str, Any]) -> None:
...
def test_load_invalid_license(project_settings_data_dict: dict[str, Any]) -> None:
...
def test_load_bad_organization(project_settings_data_dict: dict[str, Any]) -> None:
...
def test_org_formatted_name_and_email(
...
def test_org_as_pyproject_author(project_settings_data_dict: dict[str, Any]) -> None:
    project_setting = ProjectSettings.model_validate(project_settings_data_dict)
    org = project_setting.organization
