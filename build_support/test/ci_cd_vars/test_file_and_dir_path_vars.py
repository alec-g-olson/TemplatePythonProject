...
def test_get_build_support_dir(mock_project_root: Path) -> None:
...
def test_get_pypi_dir(mock_project_root: Path) -> None:
    assert get_pypi_dir(project_root=mock_project_root) == mock_project_root.joinpath(
        "pypi_package",
    )


def test_get_pulumi_dir(mock_project_root: Path) -> None:
...
def test_get_pypi_src_dir(mock_project_root: Path) -> None:
    assert get_pypi_src_dir(project_root=mock_project_root) == get_pypi_dir(
        project_root=mock_project_root,
    ).joinpath("src")


def test_get_pypi_test_dir(mock_project_root: Path) -> None:
    assert get_pypi_test_dir(project_root=mock_project_root) == get_pypi_dir(
        project_root=mock_project_root,
    ).joinpath("test")


def test_get_pypi_src_and_test(mock_project_root: Path) -> None:
...
def test_get_build_reports_dir(mock_project_root: Path) -> None:
...
def test_get_all_python_folders(mock_project_root: Path) -> None:
...
def test_get_all_src_folders(mock_project_root: Path) -> None:
...
def test_get_all_test_folders(mock_project_root: Path) -> None:
...
def test_get_all_non_test_folders(mock_project_root: Path) -> None:
    assert get_all_non_test_folders(project_root=mock_project_root) == concatenate_args(
        args=[
            get_build_support_src_dir(project_root=mock_project_root),
            get_pypi_src_dir(project_root=mock_project_root),
            get_pulumi_dir(project_root=mock_project_root),
