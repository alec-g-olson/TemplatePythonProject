...
def test_demote_process_to_user():
    ...
    with patch("build_support.dag_engine.setgid") as mock_setgid, patch(
        "build_support.dag_engine.setuid"
    ) as mock_setuid, patch(
        "build_support.dag_engine.environ", {}
    ) as mock_environ, patch(
