"""build_vars is intended to hold code that calculates variable used by tasks.

The functions, constants, and enums in these files are held here so that they can be
imported to tasks in build_tasks without fear of circular dependencies.

file_and_dir_path_vars.py: All path variables and enforcement of project structure
    should go here.
